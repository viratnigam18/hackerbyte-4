...
gl_FragDepth=readDepth(vUv);
  ...
  var EffectComposer = class {
    ...
    createDepthTexture() {
      ...
      const depthTexture = new import_three5.DepthTexture();
      ...
      if (inputBuffer.stencilBuffer) {
        ...
        depthTexture.type = import_three5.FloatType;
      }
      const stableDepthTexture = depthTexture.clone();
      stableDepthTexture.name = "EffectComposer.StableDepth";
      this.depthRenderTarget = new import_three5.WebGLRenderTarget(inputBuffer.width, inputBuffer.height, {
        depthBuffer: true,
