  ...
  return (
    <div className="w-full px-8 pb-8 grid grid-cols-1 lg:grid-cols-12 gap-6 max-w-[1600px] mx-auto auto-rows-max">
      ...
      <div className="col-span-1 lg:col-span-3 flex flex-col gap-6">
        ...
        {/* Symptom Checker */}
        <Card>
          <h3 className="text-gray-800 font-semibold mb-3">Symptom Checker</h3>
        ...
        <Card className="items-center justify-center py-8 relative">
          <h3 className="text-gray-800 font-semibold absolute top-5 left-5">Emergency Severity</h3>
          <div className="w-32 h-32 rounded-full border-[12px] border-[#40E0D0] flex flex-col items-center justify-center mt-6 shadow-sm">
             ...
             <span className="font-bold text-gray-800 tracking-wide text-lg">HIGH</span>
          </div>
        ...
        {/* AI Recommendation */}
        <Card>
          <h3 className="text-gray-800 font-semibold mb-2">AI Recommendation</h3>
          <p className="text-sm text-gray-400 italic">Waiting for analysis...</p>
        </Card>

        {/* Real-time Watch Data */}
        <Card>
          <h3 className="text-gray-800 font-semibold mb-4">Real-time Watch Data</h3>
          ...
          <div className="space-y-4">
            <div className="bg-gray-50/80 rounded-xl p-4 flex gap-4 border border-gray-100">
               ...
               <div>
                 <p className="text-xs text-gray-400 font-semibold tracking-wider">HEART BEAT</p>
                 <p className="text-xl font-bold text-gray-800">-- <span className="text-xs text-gray-400 font-normal">BPM</span></p>
               </div>
            </div>
            ...
            <div className="bg-gray-50/80 rounded-xl p-4 flex gap-4 border border-gray-100">
               ...
               <div>
                 <p className="text-xs text-gray-400 font-semibold tracking-wider">OXYGEN (SPO2)</p>
                 <p className="text-xl font-bold text-gray-800">-- <span className="text-xs text-gray-400 font-normal">%</span></p>
               </div>
            </div>

            <div className="bg-gray-50/80 rounded-xl p-4 flex gap-4 border border-gray-100">
               <div className="text-gray-500 bg-gray-100 p-2 rounded-lg h-fit"><Activity size={20} /></div>
               <div>
                 <p className="text-xs text-gray-400 font-semibold tracking-wider">STRESS LEVEL</p>
      ...
      <div className="col-span-1 lg:col-span-5 flex flex-col gap-6">
        ...
        <Card className="h-[300px] bg-slate-100 overflow-hidden relative p-0 border-0 shadow-inner">
          ...
          <div className="w-full h-full flex flex-col items-center justify-center text-slate-400 bg-slate-200/50">
            ...
            <span className="text-sm font-semibold tracking-wider absolute top-4 left-4 bg-white/80 px-3 py-1 rounded-full shadow-sm text-slate-500">MAP WINDOW</span>
          </div>
        </Card>
        ...
        <div className="grid grid-cols-2 gap-4">
           <Card>
             <h3 className="text-xs text-gray-500 font-semibold tracking-wider mb-2">Identified Condition</h3>
             <p className="text-sm text-gray-400 italic mb-4 flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-gray-300"></span> Waiting for analysis...</p>
             <h3 className="text-xs text-gray-500 font-semibold tracking-wider mb-2">Recommended Filters</h3>
             <div className="flex gap-4">
               ...
               <span className="text-xs font-semibold text-gray-400 flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-gray-300"></span> Cardiology</span>
             </div>
           </Card>
        ...
        <Card className="border-t-4 border-t-[#40E0D0]">
          <h3 className="text-gray-800 font-semibold mb-4 text-lg">Medicine & Remedies</h3>
      ...
      <div className="col-span-1 lg:col-span-4 flex flex-col gap-6 relative">
        ...
        {/* Recent Activity */}
        <Card>
          <h3 className="text-gray-800 font-semibold">Recent Activity / Medical History</h3>
        </Card>

        {/* Hospital Directory */}
        <Card>
           <h3 className="text-gray-800 font-semibold mb-3">Nearby Hospital Directory</h3>
           <p className="text-sm text-gray-500">Perform a search to see nearby hospitals.</p>
        </Card>

        {/* Telemedicine */}
        <Card className="flex-1">
          <div className="flex justify-between items-center mb-2">
            <h3 className="text-gray-800 font-semibold text-lg">Telemedicine</h3>
          ...
          <p className="text-xs text-gray-500 mb-6">Instantly connect with expert doctors available online.</p>
          
          <div className="space-y-4">
             {/* Doctor 1 */}
             <div className="flex items-center justify-between pb-4 border-b border-gray-100">
                <div>
                  <h4 className="font-semibold text-gray-800">Dr. Amit Sharma</h4>
                  <p className="text-xs text-gray-400 mb-1">Pediatrics</p>
             ...
             <div className="flex items-center justify-between pb-4 border-b border-gray-100">
                <div>
                  <h4 className="font-semibold text-gray-800">Dr. Ananya Iyer</h4>
                  <p className="text-xs text-gray-400 mb-1">Cardiology</p>
             ...
             <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-semibold text-gray-800">Dr. Kavita Rao</h4>
                  <p className="text-xs text-gray-400 mb-1">General Medicine</p>
